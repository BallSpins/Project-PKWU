...
<div class="flex justify-between max-w-screen mx-auto p-6 bg-indigo-600 items-center relative">
  ...
  <div class="relative mr-10">
    <button onclick="toggleDropdown()" class="flex items-center focus:outline-none cursor-pointer">
      <img src="<?= $profilePic ?>" alt="" class="w-10 h-10 rounded-full mr-2 border-2 border-white" />
...
<main class="flex flex-col md:flex-row min-h-screen">
  <aside class="w-full md:w-64 bg-gray-200 p-6 flex flex-col justify-between">
    <div>
      <div class="flex items-center justify-between mb-6">
        ...
        <a href="../dashboard/dashboard-guru.php" class="px-3 py-1 text-sm bg-gray-300 text-gray-800 rounded-lg hover:bg-gray-400">
          ← Kembali
        </a>
      </div>
      <a href="edit-profile-guru.php" class="block w-full text-center bg-gray-300 text-gray-800 py-2 rounded-lg mb-3 hover:bg-gray-400">Edit Profile</a>
      <a href="edit-profile-guru-pass.php" class="block w-full text-center bg-teal-500 text-white py-2 rounded-lg hover:bg-teal-600">Password</a>
    </div>
  ...
  <section class="flex-1 bg-white shadow-lg m-4 md:m-6 rounded-lg p-6 sm:p-8">
    ...
    <form class="grid gap-6" method="POST" action="../../backend/update-profile-guru-pass.php">
      ...
      <div>
        <button type="submit" class="w-1/2 bg-indigo-600 text-white font-semibold py-2 rounded-lg hover:bg-indigo-700 transition cursor-pointer">
          Simpan
        </button>
      </div>
    </form>
