...
<main class="flex flex-col md:flex-row min-h-screen">
  ...
  <section class="flex-1 bg-white shadow-lg m-4 md:m-6 rounded-lg p-6 sm:p-8">
    <h2 class="text-lg sm:text-xl font-bold mb-6">Ubah Password Guru</h2>
    ...
    <form class="grid gap-6" method="POST" action="../../backend/update-profile-guru-pass.php">
      ...
      <div>
        <button type="submit"
                class="w-1/2 bg-indigo-600 text-white font-semibold py-2 rounded-lg hover:bg-indigo-700 transition cursor-pointer">
          Simpan
        </button>
      </div>
    </form>
