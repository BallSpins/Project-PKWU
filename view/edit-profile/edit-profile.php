  ...
  <main class="flex flex-col md:flex-row min-h-screen">
    ...
    <aside class="w-full md:w-64 bg-gray-200 p-6 flex flex-col justify-between">
      <div>
        ...
        <a href="edit-profile.php" class="block w-full text-center bg-teal-500 text-white py-2 rounded-lg mb-3 hover:bg-teal-600">Edit Profile</a>
        <a href="edit-profile-pass.php" class="block w-full text-center bg-gray-300 text-gray-800 py-2 rounded-lg hover:bg-gray-400">Password</a>
      </div>
    ...
    <div>
      ...
      <select name="jurusan" class="mt-1 block w-full border-gray-300 rounded-lg shadow-sm p-2">
        <option <?php if($jurusan=="Rekayasa Perangkat Lunak") echo "selected"; ?>>Rekayasa Perangkat Lunak</option>
        <option <?php if($jurusan=="Design Komunikasi Visual") echo "selected"; ?>>Design Komunikasi Visual</option>
        <option <?php if($jurusan=="Bisnis Digital") echo "selected"; ?>>Bisnis Digital</option>
        <option <?php if($jurusan=="Manajemen Perkantoran") echo "selected"; ?>>Manajemen Perkantoran</option>
        <option <?php if($jurusan=="Akuntansi") echo "selected"; ?>>Akuntansi</option>
        <option <?php if($jurusan=="Layanan Perbankan") echo "selected"; ?>>Layanan Perbankan</option>
        <option <?php if($jurusan=="Usaha Layanan Wisata") echo "selected"; ?>>Usaha Layanan Wisata</option>
      </select>
    </div>
